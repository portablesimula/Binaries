...
public final class HegnaNRK$PBLK21$hent_innbase$SubBlock1199 extends BASICIO$ {
    ...
    public RTObject$ STM$() {
        ...
        ((HegnaNRK$PBLK21)(CUR$.SL$.SL$)).antall_felt_def=((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1198$6.inint();
        ...
        // JavaLine 32 ==> SourceLine 1204
        {
            ...
            j=((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1198$6.inint();
            // JavaLine 36 ==> SourceLine 1205
            t=blanks(((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1198$6.inint());
            // JavaLine 38 ==> SourceLine 1206
            c=((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1198$6.inchar();
            // JavaLine 40 ==> SourceLine 1207
            while(TXT$.more(t)) {
                TXT$.putchar(t,((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1198$6.inchar());
            }
            ...
            ((HegnaNRK$PBLK21)(CUR$.SL$.SL$)).felttype_tabell.Elt[j-((HegnaNRK$PBLK21)(CUR$.SL$.SL$)).felttype_tabell.LB[0]]=((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1198$6.inint();
            TRACE_END_STM$("CompoundStatement1204",1209);
        }
    }
    // JavaLine 51 ==> SourceLine 1212
    ((HegnaNRK$PBLK21)(CUR$.SL$.SL$)).antall_format_def=((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1198$6.inint();
    ...
    // JavaLine 57 ==> SourceLine 1215
    {
        ...
        {
            // BEGIN INSPECTION 
            ((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1220$7=new HegnaNRK$PBLK21$format(((HegnaNRK$PBLK21)(CUR$.SL$.SL$)),((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1198$6.inint()).STM$();
            if(((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1220$7!=null) //INSPECT inspect$1220$7
            // JavaLine 76 ==> SourceLine 1222
            {
                TRACE_BEGIN_STM$("CompoundStatement1222",1222);
                for(boolean CB$1222:new ForList(
                    new StepUntil(new NAME$<Number>(){ public Number put(Number x$){k=(int)x$; return(x$);};  public Number get(){return((Number)k); }	},new NAME$<Number>() { public Number get(){return(1); }},new NAME$<Number>() { public Number get(){return(1); }},new NAME$<Number>() { public Number get(){return(((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1220$7.p$antall); }})
                   )) { if(!CB$1222) continue;
                ((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1220$7.fnr.Elt[k-((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1220$7.fnr.LB[0]]=((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1198$6.inint();
            }
            // JavaLine 84 ==> SourceLine 1223
            for(boolean CB$1223:new ForList(
                new StepUntil(new NAME$<Number>(){ public Number put(Number x$){k=(int)x$; return(x$);};  public Number get(){return((Number)k); }	},new NAME$<Number>() { public Number get(){return(1); }},new NAME$<Number>() { public Number get(){return(1); }},new NAME$<Number>() { public Number get(){return(((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1220$7.p$antall); }})
               )) { if(!CB$1223) continue;
            ((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1220$7.spos.Elt[k-((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1220$7.spos.LB[0]]=((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1198$6.inint();
        }
        // JavaLine 90 ==> SourceLine 1224
        ((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1220$7.ark_lengde=((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1198$6.inint();
        // JavaLine 92 ==> SourceLine 1225
        ((HegnaNRK$PBLK21)(CUR$.SL$.SL$)).format_peker.Elt[j-((HegnaNRK$PBLK21)(CUR$.SL$.SL$)).format_peker.LB[0]]=((HegnaNRK$PBLK21$format)((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1220$7);
...
((HegnaNRK$PBLK21)(CUR$.SL$.SL$)).antall_poster=((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1198$6.inint();
...
pnr=((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1198$6.inint();
// JavaLine 117 ==> SourceLine 1235
{
// BEGIN INSPECTION 
((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1235$8=new HegnaNRK$PBLK21$post(((HegnaNRK$PBLK21)(CUR$.SL$.SL$)),((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1198$6.inint()).STM$();
if(((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1235$8!=null) //INSPECT inspect$1235$8
// JavaLine 122 ==> SourceLine 1236
for(boolean CB$1236:new ForList(
    new StepUntil(new NAME$<Number>(){ public Number put(Number x$){j=(int)x$; return(x$);};  public Number get(){return((Number)j); }	},new NAME$<Number>() { public Number get(){return(1); }},new NAME$<Number>() { public Number get(){return(1); }},new NAME$<Number>() { public Number get(){return(((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1235$8.p$antall); }})
   )) { if(!CB$1236) continue;
// JavaLine 126 ==> SourceLine 1238
{
TRACE_BEGIN_STM$("CompoundStatement1238",1238);
((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1235$8.feltnr.Elt[j-((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1235$8.feltnr.LB[0]]=((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1198$6.inint();
...
if((k==(1))) {
    // JavaLine 134 ==> SourceLine 1242
    {
        ...
        ((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1235$8.felt.Elt[j-((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1235$8.felt.LB[0]]=new HegnaNRK$PBLK21$heltallverdi(((HegnaNRK$PBLK21)(CUR$.SL$.SL$))).STM$();
        // JavaLine 138 ==> SourceLine 1243
        ((HegnaNRK$PBLK21$heltallverdi)(((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1235$8.felt.Elt[j-((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1235$8.felt.LB[0]])).tall=((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1198$6.inint();
...
if((k==(2))) {
    // JavaLine 145 ==> SourceLine 1248
    {
        ...
        ((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1235$8.felt.Elt[j-((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1235$8.felt.LB[0]]=new HegnaNRK$PBLK21$tekstverdi(((HegnaNRK$PBLK21)(CUR$.SL$.SL$))).STM$();
        ...
        ((HegnaNRK$PBLK21$tekstverdi)(((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1235$8.felt.Elt[j-((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1235$8.felt.LB[0]])).tekst=t;
        TRACE_END_STM$("CompoundStatement1248",1252);
    }
}
// JavaLine 162 ==> SourceLine 1254
((HegnaNRK$PBLK21)(CUR$.SL$.SL$)).post_peker.Elt[pnr-((HegnaNRK$PBLK21)(CUR$.SL$.SL$)).post_peker.LB[0]]=((HegnaNRK$PBLK21$post)((HegnaNRK$PBLK21$hent_innbase)(CUR$.SL$)).inspect$1235$8);
