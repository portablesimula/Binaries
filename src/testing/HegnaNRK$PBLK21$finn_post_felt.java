...
public final class HegnaNRK$PBLK21$finn_post_felt extends BASICIO$ {
    ...
    public HegnaNRK$PBLK21$finn_post_felt(RTObject$ SL$,int sp$pnr,int sp$finr) {
        ...
        BBLK();
        // Declaration Code
        TRACE_BEGIN_DCL$("finn_post_felt",735);
        STM$();
    } // End of Constructor
    // Procedure Statements
    public HegnaNRK$PBLK21$finn_post_felt STM$() {
        TRACE_BEGIN_STM$("finn_post_felt",735);
        ...
        // JavaLine 64 ==> SourceLine 734
        {
            ...
            while(((!(funnet))&((i<(inspect$734$0.p$antall))))) {
                // JavaLine 71 ==> SourceLine 737
                {
                    ...
                    if((fnr==(inspect$734$0.feltnr.Elt[i-inspect$734$0.feltnr.LB[0]]))) {
    ...
    public static PROGINFO$ INFO$=new PROGINFO$("HegnaNRK.sim","Procedure finn_post_felt",1,726,16,728,20,729,23,735,56,730,58,731,60,732,62,733,64,734,69,735,71,737,75,738,77,740,81,741,90,744,95,745);
}
