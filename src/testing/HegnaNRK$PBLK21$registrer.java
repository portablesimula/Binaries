...
public final class HegnaNRK$PBLK21$registrer extends BASICIO$ {
            ...
            try {
                ...
                if((((HegnaNRK$PBLK21)(CUR$.SL$)).rest>=(((float)(10))))) {
                    // JavaLine 49 ==> SourceLine 534
                    {
                        ...
                        sysout().outint(1,3);
                        sysout().outtext(new TXT$(":  Østlandet  :"));
                        sysout().outint(34,3);
                        sysout().outimage();
                        // JavaLine 59 ==> SourceLine 536
                        sysout().outint(2,3);
                        sysout().outtext(new TXT$(":  Sørlandet  :"));
                        sysout().outint(14,3);
                        sysout().outimage();
                        ...
                        new HegnaNRK$PBLK21$lede_tekst(((HegnaNRK$PBLK21)(CUR$.SL$)),new TXT$("Hvilken gruppe ønsker De,angi nummer:"));
                        ...
                        sysout().outint(3,3);
                        sysout().outtext(new TXT$(":  Møre og Romsdal      :"));
                        sysout().outint(4,2);
                        sysout().outimage();
                        ...
                        i=sysin().inint();
                        i=2;
                        ((HegnaNRK$PBLK21)(CUR$.SL$)).rest=((float)(8));
                ...
                if((((HegnaNRK$PBLK21)(CUR$.SL$)).rest<(((float)(10))))) {
                    // JavaLine 124 ==> SourceLine 555
                    {
                        ...
                        sysout().outtext(new TXT$("Det er forbudt å offentliggjøre persondata for "));
                        sysout().outimage();
                        // JavaLine 129 ==> SourceLine 556
                        sysout().outtext(new TXT$("grupper med færre enn 10 personer"));
                        sysout().outimage();
                        ...
                        if((c==('J'))) {
                            // JavaLine 145 ==> SourceLine 562
                            {
                                ...
                                sysout().outtext(new TXT$("Å neida, den går ikke, De lurer ikke meg!"));
                                sysout().outimage();
                                // JavaLine 150 ==> SourceLine 563
                                sysout().outtext(new TXT$("De står ikke i Datatilsynets spesial-register!"));
                                sysout().outimage();
                                // JavaLine 153 ==> SourceLine 564
                                sysout().outtext(new TXT$("Svar nå ærlig på spørsmålet!"));
                                sysout().outimage();
                        ...
                        sysout().outtext(new TXT$("Nei da så, "));
                        // JavaLine 163 ==> SourceLine 568
                        sysout().outtext(new TXT$("beklager at jeg ikke kan gi Dem den ønskede utskrift."));
    ...
    public static PROGINFO$ INFO$=new PROGINFO$("HegnaNRK.sim","Procedure registrer",1,522,11,558,14,524,33,525,35,527,39,528,41,529,47,532,49,534,54,535,59,536,64,537,69,538,74,539,76,540,79,541,81,542,84,543,89,544,94,545,99,546,104,547,106,548,110,549,112,550,114,551,116,552,122,554,124,555,129,556,132,557,135,558,138,559,143,560,145,562,150,563,153,564,156,565,161,567,163,568,165,569,186,571);
}
