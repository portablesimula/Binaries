...
public final class HegnaNRK$PBLK21$hent extends BASICIO$ {
    ...
    public HegnaNRK$PBLK21$hent STM$() {
        ...
        if(((pnr<=(0))|((pnr>(((HegnaNRK$PBLK21)(CUR$.SL$)).max_antall_poster))))) {
            // JavaLine 31 ==> SourceLine 719
        ...
        // JavaLine 34 ==> SourceLine 720
        {
            ...
            if((((HegnaNRK$PBLK21)(CUR$.SL$)).aktuell!=(pnr))) {
    ...
    public static PROGINFO$ INFO$=new PROGINFO$("HegnaNRK.sim","Procedure hent",1,712,11,714,25,715,27,716,29,717,31,719,34,720,38,721,40,722,49,724);
}
