...
public final class HegnaNRK$PBLK21$tekstverdi$skriv extends BASICIO$ {
    ...
    public HegnaNRK$PBLK21$tekstverdi$skriv STM$() {
        ...
        j=TXT$.length(((HegnaNRK$PBLK21$tekstverdi)(CUR$.SL$)).tekst);
        ...
        while((i<(j))) {
            // JavaLine 38 ==> SourceLine 192
            {
                ...
                TXT$.setpos(((HegnaNRK$PBLK21$tekstverdi)(CUR$.SL$)).tekst,k);
                // JavaLine 46 ==> SourceLine 195
                c=TXT$.getchar(((HegnaNRK$PBLK21$tekstverdi)(CUR$.SL$)).tekst);
