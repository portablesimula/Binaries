...
public final class HegnaNRK$PBLK21$datareg extends BASICIO$ {
    ...
    public HegnaNRK$PBLK21$datareg(RTObject$ SL$) {
        ...
        BBLK();
        // Declaration Code
        TRACE_BEGIN_DCL$("datareg",1046);
        STM$();
    } // End of Constructor
    // Procedure Statements
    public HegnaNRK$PBLK21$datareg STM$() {
        TRACE_BEGIN_STM$("datareg",1046);
...
public static PROGINFO$ INFO$=new PROGINFO$("HegnaNRK.sim","Procedure datareg",1,1040,11,1042,15,1043,17,1046,31,1044,33,1045,38,1047,42,1048,44,1050,48,1051,52,1053,56,1054,58,1055,60,1056,62,1057,64,1058,69,1059,71,1060,73,1061,78,1063,80,1064,82,1065,84,1066,88,1067,99,1070);
}
